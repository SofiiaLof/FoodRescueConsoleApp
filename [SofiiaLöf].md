...
och hur kan vi implentera detta. Jag skapade en grupp-chat på Discord och la till alla gruppmedlemmar för bättre kommunikation i mellan oss.
...
- För att undvika ovanämnda kunde vi redan i början (planeringsfasen) bestämma vilka tider passar bäst för alla att sitta med projektarbetet och vilken kommunikatonform alla föredrar.

## Implementering 
Vi bestämde att vi implementerar våra frontend-delar som Console App och jag har varit ansvarig för `CustomerClient`. 
För min lösning skapade jag en meny där användare kunde välja vad den vill göra. Jag bästämde att ha hjälp-funktioner som anropas beroende på användarens val.
...
hjälp-metoden som ligger i `CustomerBackend` för att hämta referens till önskade rekords i våran databas. 

Jag har också skapat ett ny test-suite som heter `CustomerBackendTests`. Där har jag implmenterat två stycken tester: den ena testet testar metoden för osålda matlådor och den andra 
...
Jag fick även hjälpa mina gruppmedlemar med deras del av arbete när de kände att de har stött på problem, detta hjälpte mig att bli bättre på att förklara 
...
- Vi var överens att det vore bra att skapa två olika databser om vi hade tid över: den ena som är avsedd för tester och den andra som är vår live-databsen.
- Om vi hade tid över så tycker jag att vi kunde förbättra våra lösningar med extra feautures som t.ex se en total förtjänst för en specifik restaurang eller 
skapa en inlogning på `AdminClient` så admin kunde också logga in från sin vyn.


### Egen reflektion
Jag tycker att övelag fungerade vårat samarbete bra, alla gjorde sin del och kunde bidra så vi har hunnit att göra klart vårat projektet i tid. :)
